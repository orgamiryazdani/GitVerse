...
export const CommitCard: React.FC<commitCardProps> = ({ commit, committer, showModal }) => {
  ...
  return (
    <div onClick={showModal} className="border-b dark:border-light-300 border-dark-400 pb-2 cursor-pointer">
