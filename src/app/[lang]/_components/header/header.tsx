...
export const Header = () => {
  ...
  return (
    <header
      className={`dark:text-white w-full h-[11vh] min-h-[70px] max-h-[70px] dark:bg-dark-200 bg-light-300 flex transition-all duration-200 ease-in-out ${showMenu ? 'mt-56' : 'mt-0'}`}
    >
