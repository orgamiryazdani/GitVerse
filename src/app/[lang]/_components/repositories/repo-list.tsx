  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="lg:w-2/5 w-full h-96 rounded-xl dark:bg-dark-300 bg-light-300 border-[10px] dark:border-dark-300 border-light-300 overflow-y-auto flex flex-wrap gap-3">
